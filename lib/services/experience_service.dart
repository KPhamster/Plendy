...
class ExperienceService {
  ...
  Future<void> toggleReviewLike(String reviewId) async {
    ...
    return _firestore.runTransaction((transaction) async {
      ...
      final List<String> likedBy = List<String>.from(reviewData['likedByUserIds'] ?? []);
  ...
  Future<void> toggleCommentLike(String commentId) async {
    ...
    return _firestore.runTransaction((transaction) async {
      ...
      final List<String> likedBy = List<String>.from(commentData['likedByUserIds'] ?? []);
  ...
  Future<void> toggleReelLike(String reelId) async {
    ...
    return _firestore.runTransaction((transaction) async {
      ...
      final List<String> likedBy = List<String>.from(reelData['likedByUserIds'] ?? []);
